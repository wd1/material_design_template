            ...
            <VRow>
              ...
              >
                ...
                <VTextField
                  ...
                  :append-inner-icon="isCurrentPasswordVisible ? 'mdi-eye-outline' : 'mdi-eye-off-outline'"
            ...
            <VRow>
              ...
              >
                ...
                <VTextField
                  ...
                  :append-inner-icon="isNewPasswordVisible ? 'mdi-eye-outline' : 'mdi-eye-off-outline'"
                  label="New Password"
        ...
        <VTable class="text-no-wrap table-header-bg rounded-0">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <span class="text-sm">{{ device.recentActivity }}</span>
              </td>
            </tr>
          </tbody>
        </VTable>
