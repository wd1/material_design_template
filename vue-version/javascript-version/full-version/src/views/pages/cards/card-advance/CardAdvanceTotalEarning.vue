...
const resolveProgressColor = storeName => {
  if (storeName === 'Amazon')
    return 'primary'
    ...
    <VCardText>
      <div class="d-flex align-center">
        ...
        <VIcon
          ...
          size="30"
        />
        <span class="text-success font-weight-semibold">22%</span>
      </div>
      ...
      <div
        ...
        class="mb-7"
      >
        <div class="d-flex justify-space-between mb-1 font-weight-semibold text-high-emphasis">
